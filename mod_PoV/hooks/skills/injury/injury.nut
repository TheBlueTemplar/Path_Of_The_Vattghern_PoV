	...
	q.onAdded = @(__original) function()
	{
		...
		if (this.Tactical.isActive())
		{
			if (this.getContainer().hasSkill("effects.adrenaline") == false)
			{
				...
				if (::MSU.isKindOf(this, "orc_elite") || ::MSU.isKindOf(this, "orc_warlord") || ::MSU.isKindOf(this, "orc_berserker") || actor.getSkills().hasSkill("effects.pov_orc_mutagen") || actor.getSkills().hasSkill("effects.pov_enemy_mutation_orc"))
				{
