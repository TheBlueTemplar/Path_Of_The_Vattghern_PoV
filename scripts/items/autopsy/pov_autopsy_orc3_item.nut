this.pov_autopsy_orc3_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.pov_autopsy_orc3_item";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/pov_autopsy_orc3.png";
		this.m.Value = 300;
	}
