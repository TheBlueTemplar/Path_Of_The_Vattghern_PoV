this.pov_autopsy_hexe2_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.pov_autopsy_hexe2_item";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/pov_autopsy_hexe2.png";
		this.m.Value = 300;
	}
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Acquire [color=" + this.Const.UI.Color.PositiveValue + "]1[/color] hexe mutagen upgrade.\n[color=" + this.Const.UI.Color.PositiveValue + "]15%[/color] chance."
		});
