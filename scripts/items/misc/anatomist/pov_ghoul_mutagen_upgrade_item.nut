this.pov_ghoul_mutagen_upgrade_item <- this.inherit("scripts/items/misc/anatomist/pov_anatomist2_potion_item", {
	...
	function getTooltip()
	{
		...
		result.push({
			...
			type = "text",
			icon = "ui/tooltips/warning.png",
			text = "Upgrades the Ghoul Mutation. Does not count to mutation limit"
		});
